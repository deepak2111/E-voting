...
?>
   ...
   .banner{
       background-image: url('<?php echo get_template_directory_uri();?>/images/bggardient.jpg');
...
<section id="home">
    ...
    <div class="row bg-dark banner justify-content-center align-items-center " style="height: 280vh;">
    ...
    <div class="logo">
        <img id="logo" src="<?php echo get_template_directory_uri();?>/images/pc.png" alt="pc">
        <div class="focus">
                <div class="container">
                    <div>
                ...
                <div class="container">
                      ...
                      <div class="row text-center">
                            <div class="col-md-6 col-sm-10 mb-3 justify-content-center">
                                <img  id="img" src="<?php echo get_template_directory_uri();?>/images/campus.jpg" alt="campus">
                              ...
                              <div class="button1"><a href="" class="btn btn-warning btn-lg px-4 m-3 align-items-center text-capitalize font-weight-bold">Conduct Elections</a></div>
                            </div>
                            <div class="col-md-6 col-sm-10 mb-3 justify-content-center">
                                <img  id="img" src="<?php echo get_template_directory_uri();?>/images/mnc.jpg" alt="mnc">
                            ...
                            <div class="button2"><a href="" class="btn btn-warning btn-lg px-4 m-3 align-items-center text-capitalize font-weight-bold ">Conduct Elections</a></div>
