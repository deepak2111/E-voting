							...
							<div class="about-grids">
								<div class="col-md-4 about-grid">
									<div class="about-grid1">
										<figure class="thumb">
											<img src="<?php echo get_template_directory_uri();?>/images/p1.jpg" alt=" " class="img-responsive" />
								...
								<div class="col-md-4 about-grid">
									<div class="about-grid1">
										<figure class="thumb">
											<img src="<?php echo get_template_directory_uri();?>/images/p3.jpg" alt=" " class="img-responsive" />
											<figcaption class="caption">
								...
								<div class="col-md-4 about-grid">
									<div class="about-grid1">
										<figure class="thumb">
											<img src="<?php echo get_template_directory_uri();?>/images/p2.jpg" alt=" " class="img-responsive" />
											<figcaption class="caption">
						...
						<div class="banner-wrap">
							<div class="about-grids">
								<div class="col-md-4 about-grid">
									<div class="about-grid1">
										<figure class="thumb">
											<img src="<?php echo get_template_directory_uri();?>/images/1.jpg" alt=" " class="img-responsive" />
											<figcaption class="caption">
												<h3><a href="#">James Cameron</a></h3>
												<span>Manager.</span>
												<p> It was popularised in the 1960s with the release of Letraset sheets.</p>
								...
								<div class="col-md-4 about-grid">
									<div class="about-grid1">
										<figure class="thumb">
											<img src="<?php echo get_template_directory_uri();?>/images/3.jpg" alt=" " class="img-responsive" />
											<figcaption class="caption">
						...
						<div class="banner-wrap">
							<div class="about-grids">
								<div class="col-md-4 about-grid">
									<div class="about-grid1">
										<figure class="thumb">
											<img src="<?php echo get_template_directory_uri();?>/images/5.jpg" alt=" " class="img-responsive" />
											<figcaption class="caption">
												<h3><a href="#">James Cameron</a></h3>
												<span>Manager.</span>
												<p> It was popularised in the 1960s with the release of Letraset sheets.</p>
								...
								<div class="col-md-4 about-grid">
									<div class="about-grid1">
										<figure class="thumb">
											<img src="<?php echo get_template_directory_uri();?>/images/2.jpg" alt=" " class="img-responsive" />
											<figcaption class="caption">
												<h3><a href="#">Michael Andrew</a></h3>
												<span>Secretary.</span>
												<p> It was popularised in the 1960s with the release of Letraset sheets.</p>
		...
		<div class="container">
			<div class="footer-grids">
				<figure class="effect-winston">
					<img src="<?php echo get_template_directory_uri(); ?>/images/1.jpg" alt="" class="img-responsive one" />
					<figcaption> 
				...
				<figure class="effect-winston">
					<img src="<?php echo get_template_directory_uri(); ?>/images/3.jpg" alt="" class="img-responsive one" />
					<figcaption>
				...
				<figure class="effect-winston">
					<img src="<?php echo get_template_directory_uri(); ?>/images/5.jpg" alt="" class="img-responsive one" />
					<figcaption>
